...
const uint8_t g_preset_table_CHORUS_RATE    [] = {16 , 16 , 16 , 16 , 16 , 32 , 16 , 16 };
const uint8_t g_preset_table_CHORUS_DELAY_T [] = {80 , 80 , 80 , 80 , 80 , 20 , 80 , 80 };
const uint8_t g_preset_table_CHORUS_MODE    [] = {127, 127, 127, 127, 127, 127, 0  , 0  };
