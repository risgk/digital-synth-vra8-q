...
- v5.0.0: Fix wave tables (Reduce noise); Narrow the range of CUTOFF frequency (min: 905.8 Hz, max: 14.5 kHz); Narrow the Q range of RESONANCE (min: 0.7, max: 4.0); Increasing RESONANCE does not decrease the filter gain; Change the recommended circuits; Rename PRESET #7 NEUTRAL to INITIAL; Other changes
