...
- v4.1.0: Fix wave tables (Reduce noise); Change the range of CUTOFF frequency (min: 466.2 Hz, max: 14.5 kHz); Change the recommended circuits; Rename PRESET #7 NEUTRAL to INITIAL; Other changes
